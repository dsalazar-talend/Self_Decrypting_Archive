<html>
  <head>
    <title>Juergen Gaertner - SDA Create</title>
  </head>
  <body bgcolor="#eafff8" text="#000000">
    <script language="Javascript" bgcolor="#eafff8">
      ...
      Polynomials31 = new Array(0x40c6e78f, 0x44ea7b19, 0x45da25ce, 0x470c368e, 0x4920f4c1, 0x4a2fb865, 0x4b641875, 0x4d474412, 0x4c175700, 0x4e880047, 0x50a5894c, 0x51ae3883, 0x531df126, 0x563e62e8, 0x586801c2, 0x5bef4706, 0x5c14c48a, 0x5d06e2a7, 0x5f2f8a72, 0x623311d9, 0x65616f52, 0x668043b4, 0x672161c9, 0x67f0a6a8, 0x6814750f, 0x6c4920c3, 0x6dca541b, 0x6e97e1ed, 0x70963ac8, 0x72de5f24, 0x7411688a, 0x7502196b, 0x76202331, 0x7887a9e1, 0x790621f4, 0x7e79deae, 0x7faca450);

      function pn() {
        do {
          MSB = State31 & 0x80000000;
          State31 &= 0x7fffffff;
          if (State31 & 1) State31 = (State31 >>> 1) ^ Polynom31;
          else State31 >>>= 1;
          if (State33 & 0x80000000) State31 |= 0x80000000;
          if (MSB) State33 = (State33 << 1) ^ Polynom33;
          else State33 <<= 1;
          MSB = (State64H & 1);
          State64H >>>= 1;
          State64H |= State64L & 0x80000000;
          if (MSB) State64L = (State64L << 1) ^ Polynom64;
          else State64L <<= 1;
        }
        while (State64L & Butt);
